...
def default():
  ...
  # Optimization
  update_every = 30
  update_epochs = 25 # this might mean how many times to update the parameters using this one sampled data
  optimizer = tf.train.AdamOptimizer
  update_epochs_policy = 64 # minibatch size?
