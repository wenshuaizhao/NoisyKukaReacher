...
class Kuka:
  ...
  def applyAction(self, motorCommands):
    ...
    if (self.useInverseKinematics):
      ...
      # print('pos is:',pos,'#######','orn is:',orn)
      if (self.useNullSpace == 1):
        if (self.useOrientation == 1):
          # print('############## self.useOrientation is 1!')
        ...
        if (self.useOrientation == 1):
          # print('self.useNullSpace != 1 and self.useOrientation == 1')
          jointPoses = p.calculateInverseKinematics(self.kukaUid,
                                                    self.kukaEndEffectorIndex,
                                                    pos,
                                                    orn,
      ...
      if (self.useSimulation):
        # print('############## self.useSimulation is',self.useSimulation)
        #self.useSimulation is 1
